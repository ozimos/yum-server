...
import { catererTovieye, seedMealOrders, seedOrders, seedPassword }
...
module.exports = {
  ...
  'It should allow caterer to edit a meal': (browser) => {
    browser
      .click('#root > div > main > div.scroll2.gallery >' +
       'div:nth-child(3) > button.btn.pad-btn.modal-open')
      .pause(2000)
      .waitForElementVisible('body > div:nth-child(11) > div >' +
       'div > div.title.flexbox.navbar-fixed', 1000)
      .assert.containsText('body > div:nth-child(11) > div >' +
       'div > div.title.flexbox.navbar-fixed > h4', 'Meal Editor')
      .setValue('body > div:nth-child(11) > div > div > div.form3-grid >' +
       ' div:nth-child(1) > form > input:nth-child(3)', 500)
      .pause(2000)
      .click('body > div:nth-child(11) > div > div > div.form3-grid > button')
      .pause(2000)
      .assert.containsText('#root > div > main > div.scroll2.gallery > ' +
  ...
  'It should add meal to menu cart if meal\'s add to menu button is clicked':
   (browser) => {
     browser
       ...
       .pause(1000)
       .click('#accordion__body-0 > div.scroll.gallery >' +
  ...
  'It should navigate to menu cart and post menu': (browser) => {
    browser
      ...
      .pause(2000)
      .assert.containsText('body > div.ReactModalPortal > div > div >' +
      'aside > div > div:nth-child(1) > h5', 'Menu Editor')
      .pause(2000)
      .click('body > div.ReactModalPortal > div > div > aside > div >' +
  ...
  'It should show the new caterer\'s menu for the day ': (browser) => {
    browser
      .click('#accordion__title-1')
      .pause(1000)
      .assert.containsText('#accordion__body-1 > div:nth-child(2) > div >' +
      'div:nth-child(1) > p', 'plain rice with ground beef')
      .assert.containsText('#accordion__body-1 > div:nth-child(2) >' +
       ' div > div:nth-child(2) > p', 'traditional')
      .pause(1000);
  },
  'It should navigate to the caterer\'s dashboard ': (browser) => {
    browser
      ...
      .pause(1000)
      .assert.containsText('#dashboard > div > main > ' +
      'div.order_detail.flexbox.title-element > h5', 'Order History')
      .pause(1000);
  },
  'It should show order details when table row is clicked':
   (browser) => {
     browser
       .pause(2000)
       .click('#accordion__body-2 > div:nth-child(2) > div > div.rt-table >' +
