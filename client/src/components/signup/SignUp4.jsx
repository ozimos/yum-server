...
import MyInputNoError from '../helpers/MyInputNoError';
...
class SignUp4 extends React.Component {
  ...
  handleSubmit(user, resetForm, invalidateForm) {
    // this.setState({ submitted: true });
    this.props.dispatch(userActions.signUp(user));
    invalidateForm(this.props.signupError);
  }
  disableButton() {
...
export { SignUp4 };
export default connect(mapStateToProps)(hot(module)(SignUp4));
