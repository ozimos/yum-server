...
describe('meal async actions', () => {
  ...
  it('dispatches LOGIN_REQUEST and LOGIN_SUCCESS on successfully fetching user', () => {
    ...
    const expectedActions = [
      ...
      { type: '@@router/CALL_HISTORY_METHOD', payload: { args: ['/orders'], method: 'push' } }
    ];
  ...
  it('dispatches LOGIN_REQUEST and LOGIN_FAILURE on failing creating user', () => {
  ...
  it('dispatches SIGNUP_REQUEST and SIGNUP_SUCCESS on successfully creating user', () => {
  ...
  it('dispatches SIGNUP_REQUEST and SIGNUP_FAILURE on failing creating user', () => {
