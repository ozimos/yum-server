...
menuRouter
    .route('/:id')
    .get(Authenticate.isUser, paramValidator, queryValidator, menuController.getSingleRecord)
    .delete(Authenticate.isUser, paramValidator, menuController.deleteRecord);
