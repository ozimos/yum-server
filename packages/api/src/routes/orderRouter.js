...
import { paramValidator, queryValidator, orderValidator } from '../middleware/joi';
...
orderRouter
    .route('/')
    .get(Authenticate.isUser, queryValidator, orderController.getOrdersWithLinksByDate)
    .post(
        Authenticate.isUser,
        queryValidator,
        orderValidator,
...
orderRouter
    .route('/:id')
    .get(Authenticate.isUser, paramValidator, orderController.getSingleOrderWithLinks)
    .put(
        Authenticate.isUser,
        paramValidator,
        queryValidator,
